          ...
          <div class="col-lg-3">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
                ...
                <p style="font-size: 20px;">Tahsin Agro - Total Records</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p style="font-size: 20px;">Ishfaq Agro - Total Records</p>
              </div>
              <div class="icon">
                <i class="ion ion-ios-cloud-upload"></i>
              </div>
          ...
          <div class="col-lg-3">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p style="font-size: 20px;">Tahsin Agro - Total Income</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <p style="font-size: 20px;">Ishfaq Agro - Total Income</p>
              </div>
              <div class="icon">
                <i class="ion ion-cash"></i>
              </div>
